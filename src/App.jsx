  ...
  async function saveWorkout(formData) {
    try {
      ...
      const rows = formData.exercises.map(exercise => ({
        ...
        weight: exercise.sets?.[0]?.weight || exercise.weight || '',
        weight_1: exercise.sets?.[0]?.weight || '',
        weight_2: exercise.sets?.[1]?.weight || '',
        weight_3: exercise.sets?.[2]?.weight || '',
        weight_4: exercise.sets?.[3]?.weight || '',
        weight_5: exercise.sets?.[4]?.weight || '',
        weight_6: exercise.sets?.[5]?.weight || '',
